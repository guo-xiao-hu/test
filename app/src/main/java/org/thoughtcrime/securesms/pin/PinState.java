...
public final class PinState {
  ...
  /**
   * Invoked whenever the Pigeon PIN is changed or created.
   */
  @WorkerThread
  ...
  /**
   * Invoked whenever a Pigeon PIN user enables registration lock.
   */
  @WorkerThread
  ...
  /**
   * Invoked whenever a Pigeon PIN user disables registration lock.
   */
  @WorkerThread
