 ...
 * managing a Pigeon Service account.
 *
...
public class SignalServiceAccountManager {
   ...
   *
   * @param configuration The URL for the Pigeon Service.
   * @param uuid The Pigeon Service UUID.
   * @param e164 The Pigeon Service phone number.
   * @param password A Pigeon Service password.
   ...
   * an SMS verification code to this Pigeon user.
   *
   ...
   * make a voice call to this Pigeon user.
   *
   * @param locale
   * @param captchaToken If the user has done a CAPTCHA, include this.
   * @param challenge    If present, it can bypass the CAPTCHA.
  ...
  /**
   * Verify a Pigeon Service account with a received SMS or voice verification code.
   *
   ...
   *                     concatenated.
   * @param signalProtocolRegistrationId A random 14-bit number that identifies this Pigeon install.
