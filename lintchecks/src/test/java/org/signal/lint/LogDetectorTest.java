...
public final class LogDetectorTest {
  ...
  public void androidLogUsed_LogNotSignal_2_args() {
    lint()
      ...
      .run()
      .expect("src/foo/Example.java:5: Error: Using 'android.util.Log' instead of a Pigeon Logger [LogNotSignal]\n" +
                "    Log.d(\"TAG\", \"msg\");\n" +
                "    ~~~~~~~~~~~~~~~~~~~\n" +
                "1 errors, 0 warnings")
  ...
  public void signalServiceLogUsed_LogNotApp_2_args() {
    lint()
      ...
      .run()
      .expect("src/foo/Example.java:5: Error: Using Pigeon server logger instead of app level Logger [LogNotAppSignal]\n" +
                "    Log.d(\"TAG\", \"msg\");\n" +
                "    ~~~~~~~~~~~~~~~~~~~\n" +
                "1 errors, 0 warnings")
      .expectFixDiffs("Fix for src/foo/Example.java line 5: Replace with org.signal.core.util.logging.Log.d(\"TAG\", \"msg\"):\n" +
